#!/usr/bin/env python3
"""Refresh the LPIPS metric table used directly by unweighted notebooks."""
...
def main() -> int:
    ...
    artifact_roots = args.artifact_root or [
        args.project_root / "results" / "unweighted" / prefix / family / "sunset"
    ...
    output_path = (
        ...
        / recovery.LPIPS_METRICS_RELATIVE_PATHS["unweighted"]
    )
