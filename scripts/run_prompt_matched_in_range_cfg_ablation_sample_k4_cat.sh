...
target_root="results/prompt_matched_in_range_cfg_ablation_sample_k4_cat/diffusion_backprop"
reference_root="results/prompt_matched_in_range_sample_k4_cat/diffusion_backprop"
mkdir -p "${target_root}"
...
"${PYTHON_BIN}" run_conditioning_regression.py \
  --suite-config configs/prompt_matched_in_range_cfg_ablation_sample_k4_cat_suite.json \
