...
target_root="results/ablation/prompt_mismatched_old/sunset/sample_k4_cat"
first4_root="results/prompt_mismatched/sunset/first4_sample_k4_cat"
last3_root="results/prompt_mismatched/sunset/last3_sample_k4_cat"
mkdir -p "${target_root}"
...
"${PYTHON_BIN}" run_conditioning_regression.py   --suite-config configs/ablation/prompt_mismatched_old/sunset/sample_k4_cat_suite.json   --sampling-methods cs
