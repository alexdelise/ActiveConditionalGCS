...
target_root="results/ablation/prompt_matched/sunset/sample_k2_sunset_beach/diffusion_backprop"
first4_root="results/prompt_matched/sunset/first4_sample_k2_sunset_beach/diffusion_backprop"
last3_root="results/prompt_matched/sunset/last3_sample_k2_sunset_beach/diffusion_backprop"
mkdir -p "${target_root}"
...
"${PYTHON_BIN}" run_conditioning_regression.py \
  --suite-config configs/ablation/prompt_matched/sunset/sample_k2_sunset_beach_suite.json \
