...
target_root="results/ablation/out_of_range_old/sunset/sample_k2_sunset_beach"
first4_root="results/out_of_range/sunset/first4_sample_k2_sunset_beach"
last3_root="results/out_of_range/sunset/last3_sample_k2_sunset_beach"
mkdir -p "${target_root}"
...
"${PYTHON_BIN}" run_conditioning_regression.py   --suite-config configs/ablation/out_of_range_old/sunset/sample_k2_sunset_beach_suite.json   --sampling-methods cs
