...
names=(
  "Ktilde_SD15__fft__k1daytimebeach_cfg1_512x512_S500_ns20"
  "Ktilde_SD15__fft__k2sunsetbeach_cfg1_512x512_S500_ns20"
  "Ktilde_SD15__fft__k4cat_cfg1_512x512_S500_ns20"
)

for name in "${names[@]}"; do
  echo "[ktilde cfg1] ${name}"
