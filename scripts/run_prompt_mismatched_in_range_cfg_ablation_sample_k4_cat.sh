...
target_root="results/prompt_mismatched_in_range_cfg_ablation_sample_k4_cat/diffusion_backprop"
first4_root="results/prompt_mismatched_in_range_first4_sample_k4_cat/diffusion_backprop"
last3_root="results/prompt_mismatched_in_range_last3_sample_k4_cat/diffusion_backprop"
mkdir -p "${target_root}"
...
"${PYTHON_BIN}" run_conditioning_regression.py   --suite-config configs/prompt_mismatched_in_range_cfg_ablation_sample_k4_cat_suite.json   --dc-methods diffusion_backprop   --sampling-methods cs
