"""Build or validate a named k-tilde artifact from `ktilde/config.json`."""
...
def main() -> None:
    ...
    parser.add_argument("--config", type=str, default="ktilde/config.json", help="Path to the k-tilde catalog JSON.")
    ...
    artifact_path, _ = build_ktilde(root / "ktilde", catalog[args.name], RuntimeConfig(), force=bool(args.force))
